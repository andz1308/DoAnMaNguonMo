...
<br />
<div class="thumbnail">
    <img src="{{ asset('images/products/i1_1.png') }}" alt="Iphone Images" style="width:150px;height:150px;"/>
    <div class="caption">
...
<br />
<div class="thumbnail">
    <img src="{{ asset('images/products/s2_1.png') }}" alt="SamSung Images" style="width:150px;height:150px;"/>
    <div class="caption">
