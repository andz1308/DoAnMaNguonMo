            ...
            <div id="welcomeLine" class="row">
                ...
                <div class="span6">
                    <div class="pull-right">
                        ...
                        <a href="#"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> 0 Giỏ hàng </span> </a>
                    </div>
                </div>
            </div>
            ...
            <div id="logoArea" class="navbar">
                ...
                <div class="navbar-inner">
                    ...
                    <form class="form-inline navbar-search" method="GET" action="{{ route('search') }}">
                        <input placeholder="Bạn muốn tìm gì..." type="text" name="query" style="width:300px; height:50px;"/>
                    </form>
                        ...
                        @auth
                            <li class="nav">
                                ...
                                <ul class="nav-list">
                                    ...
                                    <li><a href="#" style="background-color:bisque">Đăng xuất</a></li>
                                </ul>
                            </li>
                        @else
                            <li class="">
                                <a href="#" role="button" data-toggle="modal" style="padding-right:0;font-size:60px">
    ...
    <div id="carouselBlk">
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="item">
                    <div class="container">
                        <a href="#"><img src="{{ asset('images/carousel/25mb-sale-samsung.jpg') }}" alt="special offers" /></a>
                        <div class="carousel-caption">
