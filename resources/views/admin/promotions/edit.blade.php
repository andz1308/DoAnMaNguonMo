...
<div class="container-fluid">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.khuyen_mai.update', $promotion->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input 
                            ...
                            id="ngay_bd" 
                            name="ngay_bd" 
                            value="{{ old('ngay_bd', isset($promotion->chiTietKhuyenMais[0]) ? $promotion->chiTietKhuyenMais[0]->ngay_bd : '') }}"
                        >
                        @error('ngay_bd')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input 
                            ...
                            id="ngay_kt" 
                            name="ngay_kt" 
                            value="{{ old('ngay_kt', isset($promotion->chiTietKhuyenMais[0]) ? $promotion->chiTietKhuyenMais[0]->ngay_kt : '') }}"
                        >
                        @error('ngay_kt')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    >
                        @forelse($sanPhams as $sp)
                            <option value="{{ $sp->id }}" @if(in_array($sp->id, old('san_phams', $selectedSanPhams))) selected @endif>
